...
export class MemoService {
    ...
    mem_URL = environment.EmemoURL + 'memserv';
    ...
    public get_EmployeeList(cckeyvalue:any, pageno:any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
    ...
    findMemoList1(
        filter:any, sortOrder = 'asc',
        pageNumber = 1, pageSize = 10,urlname:any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        // let token = tokenValue.token
    ...
    public getDepartment(deptkeyvalue:any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
    ...
    public getDepartmentPage(deptkeyvalue:any,pageno:any,type:any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token;
    ...
    public getDepartment1(deptkeyvalue:any,mydept_from:any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token;
    ...
    public getCategorySearch(catKeyValue:any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        // let token = tokenValue.token
    ...
    public creatAccountForm(data: any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
    ...
    public getTemplate(tempkeyvalue:any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
    ...
    public getModuleMappingList(empId:any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
    ...
    public getPermissionList(empId:any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
    ...
    public getSingleEmployee(empId:any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData");
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
      ...
      public getapproverDropdown(parentkeyvalue:any,memoid:any): Observable<any> {
        this.reset();
        const getToken : any = localStorage.getItem("sessionData")
        let tokenValue = JSON.parse(getToken);
        let token = tokenValue.token
        ...
        public getAssignto(id:any): Observable<any> {
            this.reset();
            const getToken : any = localStorage.getItem("sessionData");
            let tokenValue = JSON.parse(getToken);
            let token = tokenValue.token
        ...
        public getSingleEmployee_new(empId:any): Observable<any> {
            this.reset();
            const getToken : any = localStorage.getItem("sessionData");
            let tokenValue = JSON.parse(getToken);
            let token = tokenValue.token
