...
export class ShareService {
  ...
  public questypeedit=new BehaviorSubject<any>('');
  public quesheaderedit=new BehaviorSubject<any>('');
  public quesedit=new BehaviorSubject<any>('');
  public venmapedit=new BehaviorSubject<any>('');
  public activitymasteredit=new BehaviorSubject<any>('');
  public vendorsingleget=new BehaviorSubject<any>('');
  public portaluserdata = new BehaviorSubject<any>('');
