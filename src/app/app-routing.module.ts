...
const routes: Routes = [
  ...
  // {path: 'refreshroutechange', component: RefreshComponentComponent},
  ...
  // {path:'cms',loadChildren:()=> import("./contract-management-system/contract-management-system.module").then(m=>m.ContractManagementSystemModule)},
  ...
  { path: 'taskreport', loadChildren:()=> import("./taskreport/task.module").then(m=>m.TaskModule)},
  // { path:'payingemployee',loadChildren:()=> import("./payingemployee/payingemp.module").then(m=>m.PayingempModule)},
  // {path:'fet',loadChildren:()=> import("./fet/fet.module").then(m=>m.FETModule)},
  {path:'taskmanage',loadChildren:()=> import("./task-manager/task-manager.module").then(m=>m.TaskManagerModule)},
  // {path:'fet',loadChildren:()=> import("./fet/fet.module").then(m=>m.FETModule)},
  ...
  // {path:'appraise', loadChildren:()=> import("./APPRAISE/appraisal.module").then(m=>m.AppraisalModule)}
